...
const Input = ({
  ...
  // ChatGPT-style minimal palette
  const inputBg = 'transparent';
  const defaultBorder = isDark ? '#4a4a4a' : '#d0d0d0';
  const focusedBorder = isDark ? '#8e8ea0' : '#999999'; 
  const placeholderColor = isDark ? '#8e8ea0' : '#9a9a9a';
    ...
    <View style={[styles.container, style]}>
      ...
      >
        ...
        <TextInput
          ...
          style={[
            styles.input,
            { color: theme.text, fontSize: value ? 15 : secureTextEntry ? 10 : 10 },
